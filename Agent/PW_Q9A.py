...
ACTION_PROMPT = """
GÖREV: Kütüphaneciye soru sorulabilecek sayfayı bulunuz.
...
def save_logs():
    ...
    with open(f"q9A_session_{timestamp}.txt","w",encoding="utf-8") as f: f.write("\n".join(terminal_log))
    with open(f"q9A_session_{timestamp}.json","w",encoding="utf-8") as f: json.dump(json_log,f,indent=2,ensure_ascii=False)
